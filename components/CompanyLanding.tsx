...
const CompanyLanding: React.FC<{ onNavigate: (page: string) => void }> = ({ onNavigate }) => {
  return (
    <div className="animate-fade-in">
      {/* --- HERO SECTION --- */}
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden bg-[#050505]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
          <div className="inline-block mb-4">
             <span className="text-xs font-bold tracking-widest text-gray-500 uppercase">Team</span>
          </div>
      ...
      <section className="py-24 px-6 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-4xl font-bold text-white">Nuestra Misión y Visión</h2>
          </div>
      ...
      <section className="py-24 px-6 bg-[#050505]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-400">Los principios que guían todo lo que hacemos.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
            ...
            <div className="text-center px-4">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Obsesión por el Cliente</h3>
            ...
            <div className="text-center px-4">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Colaboración Radical</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <div className="text-center px-4">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Calidad y Artesanía</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <div className="text-center px-4">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Mentalidad de Crecimiento</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <div className="text-center px-4">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Integridad y Transparencia</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
      ...
      <section className="py-24 px-6 bg-[#050505] border-t border-white/5">
        <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">¿Listo para construir algo increíble juntos?</h2>
            <p className="text-gray-400 mb-10 text-lg">
              Hablemos sobre cómo podemos ayudarte a llevar tu próximo proyecto al siguiente nivel.
            </p>
            <button 
              onClick={() => onNavigate('contact')}
              className="bg-[#1a1a1a] text-white border border-white/20 px-8 py-3.5 rounded-lg font-bold hover:bg-white hover:text-black transition-all flex items-center gap-2 mx-auto"
            >
