...
const CustomSoftwareLanding: React.FC<{ onNavigate: (page: string) => void; theme?: 'dark' | 'light' }> = ({ onNavigate, theme = 'dark' }) => {
  const isDark = theme === 'dark';
  return (
    <div className={`animate-fade-in ${isDark ? 'dark' : ''} bg-white dark:bg-[#050505] text-gray-900 dark:text-white`}>
      {/* --- HERO SECTION --- */}
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden bg-white dark:bg-[#050505]">
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-indigo-50 to-white dark:bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] dark:from-indigo-900/20 dark:via-[#050505] dark:to-[#050505]"></div>
        <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button 
              ...
              className="bg-indigo-600 text-gray-900 dark:text-white px-8 py-3.5 rounded-full font-medium hover:bg-indigo-700 transition-all w-full sm:w-auto shadow-lg shadow-indigo-900/20"
            >
              Iniciar Proyecto
            </button>
            <button 
      ...
      <section className="py-24 px-6 bg-gray-50 dark:bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">¿Qué construimos?</h2>
            <p className="text-gray-600 dark:text-gray-400">Soluciones end-to-end adaptadas a tu industria.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
             {[
               ...
               <div key={i} className="bg-white dark:bg-[#111] p-8 rounded-2xl border border-white/5 hover:border-indigo-500/30 transition-all group">
      ...
      <section className="py-24 px-6 bg-white dark:bg-[#050505]">
        <div className="max-w-7xl mx-auto">
           <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                 <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">Metodología Ágil y Transparente</h2>
              ...
              <div className="bg-white dark:bg-[#111] rounded-2xl border border-gray-300 dark:border-white/10 p-2 overflow-hidden shadow-2xl">
                 <div className="bg-gray-50 dark:bg-[#0a0a0a] rounded-xl p-4 font-mono text-xs md:text-sm text-gray-700 dark:text-gray-300 overflow-x-auto">
                    ...
                    <div className="space-y-2">
                       ...
                       <p className="pl-4">{'}'});</p>
                       <p className="pl-4">&nbsp;</p>
                       <p className="pl-4"><span className="text-gray-600 dark:text-gray-500">// Deploying excellence</span></p>
      ...
      {/* --- CTA --- */}
      <section className="py-24 px-6 bg-gray-50 dark:bg-[#0a0a0a] border-t border-gray-200 dark:border-white/5">
        <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">¿Tienes una idea en mente?</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-10 text-lg">
              Hagámosla realidad con la mejor tecnología del mercado.
            </p>
            <button 
              onClick={() => onNavigate('contact')}
              className="bg-black dark:bg-white text-white dark:text-black px-8 py-3.5 rounded-lg font-bold hover:bg-gray-800 dark:hover:bg-gray-200 transition-all flex items-center gap-2 mx-auto"
            >
